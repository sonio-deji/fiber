            ...
            <div className='mt-8'>
                ...
                <form action="" className='mt-6'>
                    <label htmlFor="" className='mt-4'>
                        ...
                        <input type="text" placeholder='John Doe' className='border w-full mt-4 p-4 border-gray-200' />
                    </label>
                    <label htmlFor="" className='mt-4'>
                        <p className='font-bold mt-4'>E-mail</p>
                        <input type="email" placeholder='john@example.com'  className='border w-full mt-4 p-4 border-gray-200' />
                    </label>
                    <label>
                        <p className='font-bold mt-4'>Password</p>
                        <div className='relative'>
                        <input type="password" placeholder='At least 8 characters' className='border w-full mt-4 p-4 border-gray-200'/>
                        <svg width="24" height="24" className='absolute top-8 right-1' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
